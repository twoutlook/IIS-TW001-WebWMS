...
public partial class UserControls_ShowGYSBSDiv : BaseUserControl
{
    ...
    public IQueryable<BASE_VENDOR> GetQueryList()
    {
        ...
        if (caseList != null && caseList.Count() > 0)
        {
            ...
            {
                caseList = caseList.Where(x => !string.IsNullOrEmpty(x.cvendorid) && x.cvendorid.Contains(txtCode.Text.Trim()));
            }
    ...
    {
        //BAS_VENDORListQuery listQuery = new BAS_VENDORListQuery();
        //DataTable dtRowCount = listQuery.GetList(this.TextBox1.Text, this.txtName.Text, "0", true, -1, -1);
