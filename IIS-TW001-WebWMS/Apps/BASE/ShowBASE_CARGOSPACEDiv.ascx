<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowBASE_CARGOSPACEDiv.ascx.cs"
    Inherits="UserControls_ShowBASE_CARGOSPACEDiv" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table width="100%" class="tableFilter">
                         <tr>
                            ...
                            <td width="15%" align="left">
                             ...
                             <td width="10%" nowrap="nowrap" align="right">
                               <%= Resources.Lang.ShowBASE_CARGOSPACEDiv_Title01%>：<%--储位规格--%>
                            </td>
                            <td width="15%" align="left">
                               <asp:DropDownList ID="ddlsiteType" runat="server" Width="80px" >
                        ...
                        <tr>
                       <td width="10%" nowrap="nowrap" align="right">
                                <%= Resources.Lang.ShowBASE_CARGOSPACEDiv_Title02%>：<%--储位上是否有货--%>
                            </td>
                            <td width="15%" align="left">
                               <asp:DropDownList ID ="ddlIsAll" runat="server" Width="80px">
                                  <asp:ListItem Text="全部" Value="0"></asp:ListItem>
                                  <asp:ListItem Text="没有" Value="1" Selected="True"></asp:ListItem>
                                  <asp:ListItem Text="有" Value="2"></asp:ListItem>
                               </asp:DropDownList>
                           ...
                           <td width="10%" nowrap="nowrap" align="right">
                            ...
                            <td style="width: 65%" align="left" colspan="3">
                        ...
                        <tr>
                            <td colspan="6" id="DataGridNavigator">
                            ...
                            <td colspan="7">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="false" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowBASE_CARGOSPACEDiv_iqty%>" DataField="iqty" DataFormatString="{0:F}" /><%--库存量--%>
                                    </Columns>
                                </asp:GridView>
...
<input type="hidden" id ="hiddNewCinvcode" runat="server" />
