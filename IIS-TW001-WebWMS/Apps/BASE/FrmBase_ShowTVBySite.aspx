<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBase_ShowTVBySite.aspx.cs" Inherits="Apps_BASE_FrmBase_ShowTVBySite" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btnRefresh() {
            ...
            $.ajax({
                type: "post",
                url: "FrmBase_ShowTVBySite.aspx/GetData",
