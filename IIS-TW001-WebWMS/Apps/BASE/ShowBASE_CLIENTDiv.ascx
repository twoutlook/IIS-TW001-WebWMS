<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowBASE_CLIENTDiv.ascx.cs"
    Inherits="UserControls_ShowBASE_CLIENTDiv" %>
                ...
                <ContentTemplate>
                    <table width="95%" class="tableFilter">
                        <tr>
                            ...
                            <td style="width: 20%">
                                <asp:Button ID="btnSearch" runat="server" Text="<%$ Resources:Lang, Common_View%>" OnClick="btnSearch_Click" CausesValidation="False" 
                                    ValidationGroup="0" /><%--查看--%>
                            </td>
                        </tr>
                        <tr>
