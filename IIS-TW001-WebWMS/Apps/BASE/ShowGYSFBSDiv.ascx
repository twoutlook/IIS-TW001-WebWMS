<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowGYSFBSDiv.ascx.cs"
    Inherits="ShowGYSFBSDiv" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr>
                            <td width="15%" nowrap="nowrap">
                               <%= Resources.Lang.FrmWAREHOUSEList_LEADERCODE%>：<%--供应商编码--%>
                            </td>
                            <td width="20%">
                                <asp:TextBox ID="txtUserNo" runat="server" Width="104"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.FrmWAREHOUSEList_LEADER%>：<%--供应商名称--%>
                            </td>
                            <td width="20%">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="False" BackColor="White"
                                    ...
                                    Width="100%" AutoGenerateColumns="False" OnPageIndexChanging="gvReport_PageIndexChanging" DataKeyNames="CVENDORID"
