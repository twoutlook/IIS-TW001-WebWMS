<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowPARTByInAsnIdDiv.ascx.cs" Inherits="UserControls_ShowPARTByInAsnIdDiv" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table width="95%" class="tableFilter">
                        ...
                        <tr>
                            <td colspan="5" >
                                <asp:HiddenField ID="hfAsnId" runat="server" />
                                <asp:HiddenField ID="hfTableName" runat="server" Value="base_part" />
