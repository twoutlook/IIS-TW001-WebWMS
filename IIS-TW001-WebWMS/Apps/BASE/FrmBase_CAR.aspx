<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBase_CAR.aspx.cs" Inherits="Apps_BASE_FrmBase_CAR" MasterPageFile="~/Apps/DefaultMasterPage.master" %>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1" runat="server" id="TabMain">
                    <tr>
                        <td class="InputLabel" style="width: 13%">
                            ...
                            <asp:Label ID="lblCraneID" runat="server" Text="台车编号"></asp:Label>：<%--台车编号--%>
                        </td>
                        <td style="width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtCraneID" runat="server" ControlToValidate="txtCraneID"
                                ErrorMessage="请填写台车编号" Display="None"> </asp:RequiredFieldValidator>
                            <%--请填写台车编号!--%>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <span class="requiredSign">*</span>
                            <asp:Label ID="lblCraneNAME" runat="server" Text="台车名称"></asp:Label>：<%--台车名称--%>
                        </td>
                        <td style="width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtCraneNAME" runat="server" ControlToValidate="txtCraneNAME"
                                ErrorMessage="请填写台车名称" Display="None"> </asp:RequiredFieldValidator>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <span class="requiredSign">*</span>
