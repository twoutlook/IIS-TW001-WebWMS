...
public partial class UserControls_ShowAREADiv : BaseUserControl
{
    ...
    public IQueryable<BASE_AREA> GetQueryList()
    {
        IGenericRepository<BASE_AREA> pigeonBill = new GenericRepository<BASE_AREA>(db);
        ...
        if (caseList != null && caseList.Count() > 0)
        {
            ...
            {
                caseList = caseList.Where(x => !string.IsNullOrEmpty(x.area_name) && x.area_name.Contains(txtName.Text.Trim()));
            }
        }
        return caseList;
    }
    ...
    [Browsable(true), Description("是否显示编号")]
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //DataTable dtRowCount = listQuery.GetList(txtName.Text, "", "", "", "", "", true, -1, -1);
