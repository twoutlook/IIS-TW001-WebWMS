<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowGYSDiv.ascx.cs"
    Inherits="ShowGYSDiv" %>
                ...
                <ContentTemplate>
                    <table width="95%" class="tableFilter">
                        <tr>
                            ...
                            <td width="20%">
                                <asp:TextBox ID="txtUserNo" runat="server" Width="80"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="False" BackColor="White"
                                    ...
                                    Width="375px" AutoGenerateColumns="False" OnPageIndexChanging="gvReport_PageIndexChanging" DataKeyNames="CVENDORID"
