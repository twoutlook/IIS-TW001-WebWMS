<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BASE_TVShow_Pick.aspx.cs" Inherits=" Apps_BASE_BASE_TVShow_Pick" %>
                                        ...
                                        <table border="1" cellspacing="0" style="width: 100%">
                                            ...
                                            <tr style="height: 20%;">
                                                ...
                                                <td style="text-align: center; width: 10%">
                                                    <font size="16px"><asp:Label ID="Label1"  runat="server" Text="ERP单号"></asp:Label></font>
                                                </td>
                                                ...
                                                <td style="text-align: center; width: 10%">
                                                    <font size="16px"><asp:Label ID="Label3"  runat="server" Text="出库单号"></asp:Label></font>
                                                </td>
                                                <td style="text-align: left; width: 40%" colspan="2">
                                                    <font size="6px">
                                            ...
                                            <tr style="height: 20%;">
                                                ...
                                                <td style="text-align: center; width: 10%">
                                                    <font size="16px"><asp:Label ID="Label12"  runat="server" Text="料号"></asp:Label></font>
                                                </td>
                                                <td style="text-align: left; width: 30%">
                                                    <font size="6px">
