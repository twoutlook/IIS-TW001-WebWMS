<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBase_CAR_D.aspx.cs" Inherits="Apps_BASE_FrmBase_CAR_D" MasterPageFile="~/Apps/DefaultMasterPage.master" %>
                ...
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdBASE_CranePCLDR" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ASCRIPTION" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBase_RGV_D_ASCRIPTION%>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <%--填值--%>
