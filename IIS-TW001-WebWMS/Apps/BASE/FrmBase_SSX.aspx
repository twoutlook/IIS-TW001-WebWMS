<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBase_SSX.aspx.cs" Inherits="Apps_BASE_FrmBase_SSX" MasterPageFile="~/Apps/DefaultMasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.WMS_Common_Element_ShuSongXianGuanLi %>-&gt;<%= Resources.Lang.WMS_Common_Element_ShuSongXianDetail %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1" runat="server" id="TabMain">
                    <tr>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCraneID" runat="server" CssClass="NormalInputText" Width="95%" MaxLength="30"></asp:TextBox>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <span class="requiredSign">*</span>
                            <asp:Label ID="lblCraneNAME" runat="server" Text="<%$ Resources:Lang, WMS_Common_Element_ShuSongXianName %>"></asp:Label>：<%--输送线名称--%>
                        </td>
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCraneNAME" runat="server" CssClass="NormalInputText" Width="95%" MaxLength="30"></asp:TextBox>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <span class="requiredSign">*</span>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCRANEIP" runat="server" CssClass="NormalInputText" Width="95%" MaxLength="20"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="InputLabel" style="width: 13%">
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtEQUIPMENTNAME" runat="server" CssClass="NormalInputText" Width="95%" MaxLength="50"></asp:TextBox>
                        </td>
    ...
    <table id="Table1" style="height: 100%; width: 100%">
        ...
        <tr valign="top">
            <td valign="top" align="left" colspan="5" style="padding: 0px 0px 15px 0px;">
