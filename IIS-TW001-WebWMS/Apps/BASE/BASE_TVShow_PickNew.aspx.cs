...
public partial class Apps_BASE_BASE_TVShow_PickNew : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (configStyle == "1") //1=简约版 2=科技版
        {
            Response.Redirect("BASE_TVShow_Pick.aspx?PLCDress=" + pclDress, false);
        }
