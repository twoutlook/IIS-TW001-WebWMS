<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowBASE_OPERATOR_AREADiv.ascx.cs"
    Inherits="UserControls_ShowBASE_OPERATOR_AREADiv" %>
                ...
                <ContentTemplate>
                    <table width="95%" class="tableFilter">
                        <tr>
                            ...
                            <td style="width: 20%">
                                <asp:Button ID="btnSearch" runat="server" Text="<%$ Resources:Lang, Common_View%>" OnClick="btnSearch_Click" />
                            </td><%--查看--%>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="False" BackColor="White"
                                    ...
                                    <Columns>                                        
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmBASE_OPERATOR_AREAEdit_lblCCARGOID%>" DataField="CCARGOID" /><%--储位编码--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmBASE_OPERATORList_lblCACCOUNTID%>" DataField="CACCOUNTID" /><%--操作人编码--%>
                                    </Columns>
                                </asp:GridView>
