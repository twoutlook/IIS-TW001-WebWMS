<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BASE_TVShowINNew.aspx.cs" Inherits="Apps_BASE_BASE_TVShowINNew" %>
            ...
            <ContentTemplate>
                ...
                <div style="padding-top:0px; height: 710px; width: 1265px;" id="DivScroll">
                    <div align="center" style="background: url(../../Images/TV_Background.png) no-repeat;width: 1265px; height: 710px; background-size: 1265px 710px; ">
                        <div align="center" style="font-size: 60px; width: 100%; color: white; ">
                        ...
                        <div id="divRK" >
                            <table border="0" style="width: 100%;  color: white;  " >
                                <tr >
                                    <td >
                                        <table border="1" class="tv-table" style="width: 95%;  color: white;height:570px;margin-left: 2.5%;">
                                           <%-- <tr>
                                            ...
                                            <tr style="height: 25%;" >
                                                ...
                                                <td style="text-align: left; width: 40%;" colspan="5" id="yc">                                                   
