<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowBOM_D_CinvCode_Div.ascx.cs" Inherits="ShowBOM_D_CinvCode_Div" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr>
                            <td width="15%" nowrap="nowrap">
                               <%= Resources.Lang.ShowBOM_CinvCode_Div_WuJianBianHao%>：<%--物件编号--%>
                            </td>
                            <td width="20%">
                                <asp:TextBox ID="txtCinvcode" runat="server" Width="104"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                               <%= Resources.Lang.ShowBOM_CinvCode_Div_WuJianPinMing%>：<%--物件品名--%>
                            </td>
                            <td width="20%">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="False" BackColor="White"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowBOM_CinvCode_Div_CPARTNUMBER%>" DataField="CPARTNUMBER" /><%--BOM料号--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowBOM_CinvCode_Div_CPARTNAME%>" DataField="CPARTNAME" /><%--BOM品名--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowBOM_CinvCode_Div_CTYPE%>" DataField="CTYPE" /><%--物料类型--%>
                                    </Columns>
                                </asp:GridView>
