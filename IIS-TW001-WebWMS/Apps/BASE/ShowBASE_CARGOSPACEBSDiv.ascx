<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowBASE_CARGOSPACEBSDiv.ascx.cs"
    Inherits="ShowBASE_CARGOSPACEBSDiv" %>
...
<script type="text/javascript">
    function SetBackCargospace(ControlName, value1) {
        document.all(ControlName).value = value1;
    }
</script>
                    ...
                    <table width="95%" class="tableFilter">
                        ...
                        <%--<tr>
                            ...
                            <td style="width: 50%" colspan="3">
                               <asp:RadioButtonList ID = "rbt" runat="server" RepeatLayout="Flow">
                                   <asp:ListItem  Text="没有" Value="0" Selected="True"></asp:ListItem>
                                   <asp:ListItem  Text="有" Value="1"></asp:ListItem>
                                   <asp:ListItem  Text="全部" Value="2"></asp:ListItem>
                               </asp:RadioButtonList>
                            </td>
                            <td style="width: 20%">
                                <asp:Button ID="btnSearch" runat="server" Text="查看" OnClick="btnSearch_Click" CausesValidation="False" />
                            </td>
                        </tr>--%>
                        <tr>
