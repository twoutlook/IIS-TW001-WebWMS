...
public partial class UserControls_ShowBASE_CARGOSPACEDiv_T : BaseUserControl
{
    ...
    public IQueryable<V_BASE_CARGOSPACE_T> GetQueryList()
    {
        IGenericRepository<V_BASE_CARGOSPACE_T> pigeonBill = new GenericRepository<V_BASE_CARGOSPACE_T>(db);
    ...
    //    DataTable dtRowCount = listQuery.GetList_T("","","",this.TextBox1.Text, this.txtName.Text, "", "", "", "", "", "", "","", true, -1, -1);
