...
public partial class Apps_BASE_FrmBase_CAR_D : WMSBasePage
{
    #region 常量
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (this.IsPostBack == false)
        {
            ...
            this.GridBind();
            this.btnNew.Attributes["onclick"] = "PopupFloatWinMax('" + WMSBasePage.BuildRequestPageURL("FrmBase_CAR_PCLADDR.aspx?PLCREGION=" + txtPLCREGION.Text.Trim(), SYSOperation.New, hdnID.Value) + "','" + Resources.Lang.FrmBase_RGV_D_Msg05 + "','BASE_CAR_PLCADDR');return false;";//PLC地址详情
        }
    }
    #endregion
        ...
        if (this.CheckData())
        {
            ...
            try
            {
                ...
                else if (this.Operation() == SYSOperation.New)
                {
                    ...
                    con.Save();
                    this.AlertAndBack("FrmBase_CAR_D.aspx?" + BuildQueryString(SYSOperation.Modify, strKeyID), Resources.Lang.Common_SuccessSave); //保存成功
                    //更新主表站点数量
    ...
    protected void grdBASE_CranePCLDR_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            this.OpenFloatWinMax(linkModify, BuildRequestPageURL("frmBase_CAR_PCLADDR.aspx", SYSOperation.Modify, strKeyID), Resources.Lang.FrmBase_RGV_D_Msg05, "BASE_CAR_PLCADDR"); //PLC地址详情
        }
    }
    ...
    public bool CheckData()
    {
        ...
        {
            this.Alert(Resources.Lang.FrmBase_CAR_D_Msg04); //台车编号项不允许空！
        ...
        if (this.txtCraneID.Text.Trim().Length > 0)
        {
            ...
            {
                this.Alert(Resources.Lang.FrmBase_CAR_D_Msg05);//台车编号项超过指定的长度30！
                this.SetFocus(txtCraneID);
                return false;
            }
        }
        ...
        if (!string.IsNullOrEmpty(ddlAGVSITE.SelectedValue))
        {
            ...
            if (this.Operation() == SYSOperation.New)
            {
                ...
                if (caseList != null && caseList.Count() > 0)
                {
                    this.Alert(Resources.Lang.FrmBase_CraneConfig_two2 + "[" + ddlAGVSITE.SelectedValue + "]," + Resources.Lang.FrmBase_CAR_D_Msg01);//AGV站点[" + ddlAGVSITE.SelectedValue + "],已被其他台车站点绑定！
            ...
            {
                this.Alert(Resources.Lang.FrmBase_CraneConfig_two2 + "[" + ddlAGVSITE.SelectedValue + "]," + Resources.Lang.FrmBase_CAR_D_Msg02);//AGV站点[" + ddlAGVSITE.SelectedValue + "],与台车站点楼层不同！
                this.SetFocus(ddlAGVSITE);
                return false;
            }
        }
        ...
        if (!string.IsNullOrEmpty(ddlAGVSITE.SelectedValue))
        {
            ...
            if (this.Operation() == SYSOperation.New)
            {
                ...
                if (caseList != null && caseList.Count() > 0)
                {
                    this.Alert(Resources.Lang.FrmBase_RGV_D_Label12 + "[" + ddlStorageSite.SelectedValue + "]," + Resources.Lang.FrmBase_CAR_D_Msg03);//等待站点[" + ddlStorageSite.SelectedValue + "],已被其他台车或提升机站点绑定！
