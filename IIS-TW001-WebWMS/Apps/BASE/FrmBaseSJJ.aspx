<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBaseSJJ.aspx.cs" Inherits="Apps_BASE_FrmBaseSJJ"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.FrmBase_SJJ_D_Title01%>-&gt;<%= Resources.Lang.FrmBaseSJJ_Title01%><%--提升机线别管理-&gt;提升机线别详情--%>
</asp:Content>
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <span class="requiredSign">*</span>
                            <asp:Label ID="lblCraneNAME" runat="server" Text="<%$ Resources:Lang, FrmBase_CraneConfig_Label14%>"></asp:Label>：<%--提升机名称--%>
                        </td>
                        <td style="width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtCraneNAME" runat="server" ControlToValidate="txtCraneNAME"
                                ErrorMessage="<%$ Resources:Lang, FrmBaseSJJ_rfvtxtCraneNAME%>" Display="None"> <%--请填写提升机名称!--%>
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <span class="requiredSign">*</span>
                            <asp:Label ID="lblCRANEIP" runat="server" Text="<%$ Resources:Lang, FrmBase_CraneConfig_Label15%>"></asp:Label>：<%--提升机IP--%>
                        </td>
                        <td style="width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtCRANEIP" runat="server" ControlToValidate="txtCRANEIP"
                                ErrorMessage="<%$ Resources:Lang, FrmBaseSJJ_rfvtxtCRANEIP%>" Display="None"> <%--请填写提升机IP!--%>
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtEQUIPMENTNAME" runat="server" ControlToValidate="txtEQUIPMENTNAME"
                                ErrorMessage="<%$ Resources:Lang, FrmBase_RGV_rfvtxtEQUIPMENTNAME%>" Display="None"> </asp:RequiredFieldValidator> <%--请填写设备名称!--%>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Lang, FrmALLOCATE_DEdit_createtime%>"></asp:Label>：<%--创建时间--%>
                        </td>
                        <td style="width: 20%">
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Lang, FrmBASE_CLIENTEdit_Label4%>"></asp:Label>：<%--修改时间--%>
                        </td>
                        <td style="width: 20%">
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Lang, FrmBase_AGV_Label7%>"></asp:Label><%--停用时间--%>
                        </td>
                        <td style="width: 21%">
    ...
    <table id="Table1" style="height: 100%; width: 100%">
        <tr valign="top">
            <td valign="top" align="left" colspan="5" style="padding-bottom:15px;">
                ...
                &nbsp;&nbsp;<asp:Button ID="btnDiscontinue" runat="server" Text="<%$ Resources:Lang, FrmBase_CraneConfig_btnDiscontinue%>" OnClick="btnDiscontinue_Click" CssClass="ButtonDel" /><%--停用--%>
            </td>

            <td align="left" style="width: 10%; display: none;">
                <asp:Button ID="btnSearch" runat="server" CssClass="ButtonSearch" Style="margin-left: 60%;" Text="<%$ Resources:Lang, Common_btnSearch%>" CausesValidation="false" OnClick="btnSearch_Click"></asp:Button> <%--查询--%>
            </td>
        </tr>
        <tr>
            <td colspan="6">
                ...
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdBASE_CraneDetail" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SITETYPEName" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBase_CraneConfig_Label11%>"><%--站点类型--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ISDEFULSITE" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBase_CraneConfigEdit_DEFULSITE%>"><%--默认站点--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="FORMAT" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBASE_PARTList_CSPECIFICATIONS%>" Visible="false"><%--规格--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
