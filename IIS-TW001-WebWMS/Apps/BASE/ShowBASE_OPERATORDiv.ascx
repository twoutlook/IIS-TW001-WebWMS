<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowBASE_OPERATORDiv.ascx.cs"
    Inherits="UserControls_ShowBASE_OPERATORDiv" %>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="False" BackColor="White"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmBASE_OPERATORList_lblCACCOUNTID%>" DataField="COPERATORNAME" /><%--操作人编码--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmBASE_OPERATORList_lblCOPERATORNAME%>" DataField="CACCOUNTID" /><%--操作人姓名--%>
                                    </Columns>
                                </asp:GridView>
