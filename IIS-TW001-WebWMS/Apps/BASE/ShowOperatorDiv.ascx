<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowOperatorDiv.ascx.cs"
    Inherits="ShowOperatorDiv" %>
                ...
                <ContentTemplate>
                    <table width="95%" class="tableFilter">
                        <tr>
                            ...
                            <td width="20%">
                                <asp:TextBox ID="txtUserNo" runat="server" Width="104"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.ShowOperatorDiv_Name%>：<%--姓名--%>
                            </td>
                            <td width="20%">
                        ...
                        <tr>
                            <td colspan="5">                              
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="True" BackColor="White"
                                    ...
                                    Width="100%" AutoGenerateColumns="False"  DataKeyNames="UserNO"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmBASE_OPERATORList_lblCACCOUNTID%>" DataField="UserNO" /><%--操作人编码--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowOperatorDiv_Name%>" DataField="UserName" /><%--姓名--%>
                                    </Columns>
                                </asp:GridView>
