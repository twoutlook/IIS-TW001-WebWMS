<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowAREADiv.ascx.cs"
    Inherits="UserControls_ShowAREADiv" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr>
                            <td width="20%" nowrap="nowrap">
                               <%= Resources.Lang.FrmBASE_WL_AREA_lblPALLETID%>：<%--区域名称--%>
                            </td>
                            <td width="60%">
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="False" BackColor="White"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmBASE_WL_AREA_lblPALLETID%>" DataField="Area_Name"  ItemStyle-Width="85%"/><%--区域名称--%>
                                        <asp:BoundField DataField="Id"  ItemStyle-CssClass="hiddenValue"/>
                                    </Columns>
                                </asp:GridView>
