<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowReTurnDiv.ascx.cs" Inherits="UserControls_ShowReTurnDiv" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr>
                            <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.FrmBASE_CARGOSPACEList_lblCWAREID%>：<%--编码--%></td>
                            <td width="20%">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="false" BackColor="White" DataKeyNames="cinvname"
