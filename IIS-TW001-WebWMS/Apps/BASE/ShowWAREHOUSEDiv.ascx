<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowWAREHOUSEDiv.ascx.cs"
    Inherits="UserControls_ShowWAREHOUSEDiv" %>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="false" BackColor="White"
                                    ...
                                    Width="100%" AutoGenerateColumns="False" OnPageIndexChanging="gvReport_PageIndexChanging" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        <%--<asp:BoundField HeaderText="仓库ID" DataField="ID">
                                        </asp:BoundField> --%>                                      
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowWAREHOUSEDiv_CWAREID%>" DataField="CWAREID" /><%--仓库编码--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowWAREHOUSEDiv_CWARENAME%>" DataField="CWARENAME" /><%--仓库名称--%>
                                    </Columns>
                                </asp:GridView>
