<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true"
    Title="--<%$ Resources:Lang, FrmBASE_CLIENTList_Title01%>" CodeFile="FrmBASE_CLIENTList.aspx.cs" Inherits="BASE_FrmBASE_CLIENTList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.FrmBaseCONFIG_DEdit_Title02%>-&gt;<%= Resources.Lang.FrmBASE_CLIENTList_Title01%>  <%--基礎資料-&gt;客户管理--%>
</asp:Content>
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCCLIENTID" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblCCLIENTNAME" runat="server" Text="<%$ Resources:Lang, FrmBASE_CLIENTList_lblCCLIENTNAME%>"></asp:Label>：<%--客户名称--%>
                        </td>
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCCLIENTNAME" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtILEVER" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="InputLabel" style="width: 13%">
        ...
        <tr valign="top">
            <td valign="top" align="left">
                <asp:Button ID="btnNew" runat="server" CssClass="ButtonAdd" Text="<%$ Resources:Lang, Common_Add%>"></asp:Button>
                <%--新增--%>
            ...
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdBASE_CLIENT" runat="server" AllowPaging="True" BorderColor="Teal" DataKeyNames="ID"
                        ...
                        OnRowDataBound="grdBASE_CLIENT_RowDataBound" AllowSorting="true" CssClass="Grid" PageSize="15" OnSorting="grdBASE_CLIENT_Sorting">
                        <%--OnPageIndexChanged="grdBASE_CLIENT_PageIndexChanged" OnPageIndexChanging="grdBASE_CLIENT_PageIndexChanging"--%>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CCLIENTID" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBASE_CLIENTList_lblCCLIENTID%>"><%--客户编码--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CCLIENTNAME" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBASE_CLIENTList_lblCCLIENTNAME%>"><%--客户名称--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="CTYPE" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmBASE_CLIENTList_lblCTYPE%>"><%--客户类型--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ILEVER" DataFormatString="{0:0}" HeaderText="<%$ Resources:Lang, FrmBASE_CLIENTList_lblILEVER%>"><%--级别--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
