<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowINASN_Div.ascx.cs" Inherits="Apps_RD_ShowINASN_Div" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr >
                            <td width="15%" nowrap="nowrap">
                                <%=Resources.Lang.Common_InasnCticketCode %>
                            </td>
                            <td width="20%" >
                                <asp:TextBox ID="txtCTICKETCODE" runat="server"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="True" BackColor="White" DataKeyNames="ID"
                                    ...
                                    <Columns>                                        
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmInbill_InasnCticketCode %>" DataField="CTICKETCODE" />
                                    </Columns>
                                </asp:GridView>
