...
public partial class RD_FrmImportDateList :WMSBasePage// WebBasePage, IPageGrid
{
    ...
    public void InitPage()
    {
        ...
        this.btnUp.Attributes["onclick"] = "PopupFloatWinMax('" + BuildRequestPageURL("FrmUPGDData.aspx", SYSOperation.New, "") + "','上传工单资料','UPGD');return false;";
