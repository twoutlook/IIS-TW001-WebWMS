<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowPO_Div.ascx.cs" Inherits="UserControls_ShowPO_Div" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr>
                             <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.CommonB_IPOLINE %><%--PO项次：--%>
                            </td>
                            <td width="20%">
                                <asp:TextBox ID="txtPOLine" runat="server" Width="104"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.CommonB_CinvCode %>:<%--料号：--%>
                            </td>
                            <td width="20%">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="True" BackColor="White" DataKeyNames="IDS"
                                    ...
                                    <Columns>
                                       <%-- <asp:BoundField HeaderText="PO" DataField="PONO" />--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, CommonB_IPOLINE %>" DataField="POLINE" /><%--PO项次--%>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, FrmInbill_CinvCode %>" DataField="CINVCODE" />
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, Common_CinvName %>" DataField="CINVNAME" />
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, Common_NUM %>" DataField="IQUANTITY" />
                                       <%-- <asp:BoundField HeaderText="IDS" DataField="IDS" Visible="False"/>--%>
                                    </Columns>
                                </asp:GridView>
