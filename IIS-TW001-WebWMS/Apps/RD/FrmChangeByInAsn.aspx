<%@ Page Title="--<%$ Resources:Lang, FrmChangeByInAsn_Title1 %>" Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master"
    AutoEventWireup="true" CodeFile="FrmChangeByInAsn.aspx.cs" Inherits="Apps_RD_FrmChangeByInAsn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%=Resources.Lang.Common_InbillMangement%>-&gt;<%=Resources.Lang.FrmChangeByInAsn_Title1%><%--入库变更单(通知单)--%>
</asp:Content>
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblCInASNID" runat="server" Text="<%$ Resources:Lang, Common_InasnCticketCode %>"></asp:Label>
                           
                        </td>
                        <td style="width: 21%">
                            <asp:TextBox ID="txtInASNCode" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                    ...
                    <tr>
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Lang, Common_Cstatus %>"></asp:Label>：
                        </td>
                        <td style="width: 20%">
                    ...
                    <tr>
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Lang, Common_CreateUser %>"></asp:Label>：
                        </td>
                        <td style="width: 20%">
        ...
        <tr>
            <td colspan="6" align="left">
                ...
                &nbsp;&nbsp;<asp:Button ID="btnDelete" OnClick="btnDelete_Click" runat="server" Text="<%$ Resources:Lang, Common_DelBtn %>"
        ...
        <tr valign="top">
            <td valign="top">
              <%--  <cc1:DataGridNavigator3 ID="grdNavigatorInChange" runat="server" GridID="grdInChange"
                    ShowPageNumber="false" ExcelName="InChange" IsDbPager="True" GetExportToExcelSource="grdNavigatorInChange_GetExportToExcelSource" />--%>
            </td>
        </tr>
        <tr>
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdInChange" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="INASN_CTICKETCODE" HeaderText="<%$ Resources:Lang, FrmChangeByInAsn_INASN_CTICKETCODE %>"><%--通知单单据--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="CREATE_TIME" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"
                                HeaderText="<%$ Resources:Lang, Common_CreateDate %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
