<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucINASN_DList.ascx.cs" Inherits="Apps_RD_ucINASN_DList" %>
...
<div id="ajaxWebSearChComp" runat="server" class="ajaxWebSearChBox">
    <div id="divHeading">
        <div class="ajaxWebSearchCloseLink" title="<%= Resources.Lang.ShowINASN_aCloseLink %>" id="aCloseLink" onclick="document.all('<%=ajaxWebSearChComp.ClientID %>').style.display='none'"><%--关闭--%>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr>
                            <td width="15%" nowrap="nowrap">
                               <%= Resources.Lang.ucINASN_DList_MSG1 %>: <%--编码：--%>
                            </td>
                            <td width="20%">
                                <asp:TextBox ID="txtCode" runat="server" Width="104"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.ucINASN_DList_MSG2 %>:<%--名称：--%>
                            </td>
                            <td width="20%">
