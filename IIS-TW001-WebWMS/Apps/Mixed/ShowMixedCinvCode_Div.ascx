<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowMixedCinvCode_Div.ascx.cs" Inherits="Apps_Mixed_ShowMixedCinvCode_Div" %>
                    ...
                    <table width="95%" class="tableFilter">
                        <tr >
                            <td width="15%" nowrap="nowrap">
                                <%= Resources.Lang.FrmALLOCATEList_Label3%>：<%--料号--%>
                            </td>
                            <td width="20%" >
                            ...
                            <td style="width: 20%">
                                <asp:Button ID="btnSearch" runat="server" Text="<%$ Resources:Lang, Common_View%>" OnClick="btnSearch_Click" ValidationGroup="0" CausesValidation="False" />
                            </td>
                        </tr>
                        <tr>
