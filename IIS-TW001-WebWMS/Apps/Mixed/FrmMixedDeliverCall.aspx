<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Apps/DefaultMasterPage.master" CodeFile="FrmMixedDeliverCall.aspx.cs" Inherits="Apps_Mixed_FrmMixedDeliverCall" %>
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <asp:DropDownList ID="ddlckSite" runat="server" Width="95%">
                            </asp:DropDownList>
                           
                            <asp:RequiredFieldValidator ID="rfvddlckSite" runat="server" ControlToValidate="ddlckSite"
        ...
        <tr valign="top">
            <td valign="top" align="left" class="style1">
                <asp:Button ID="btnSave" runat="server" CssClass="ButtonSave" OnClick="btnSave_Click"
                    Text="<%$ Resources:Lang, FrmMixedDeliverCall_CallCar%>" />  <%--叫车--%>
                &nbsp;&nbsp;
