<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowOutASNMixed_Div.ascx.cs" Inherits="Apps_Mixed_ShowOutASNMixed_Div" %>
                ...
                <ContentTemplate>
                    <table width="95%" class="tableFilter">
                        <tr >
                            ...
                            <td width="20%" >
                                <asp:TextBox ID="txtCerpCode" runat="server"></asp:TextBox>
                            </td>
                            <td width="15%" nowrap="nowrap">
                                &nbsp;
                            </td>
                            ...
                            <td style="width: 20%">
                                <asp:Button ID="btnSearch" runat="server" Text="<%$ Resources:Lang, Common_View%>" OnClick="btnSearch_Click" ValidationGroup="0" CausesValidation="False" /><%--查看--%>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="false" BackColor="White" DataKeyNames="cerpcode"
                                    ...
                                    <Columns>                                        
                                        <asp:BoundField HeaderText="CERPCODE" DataField="CERPCODE" />
                                    </Columns>
                                    <%--<Columns>                                        
                                        <asp:BoundField HeaderText="ERPCODE" DataField="CERPCODE" />
                                    </Columns>
                                    <Columns>                                        
                                        <asp:BoundField HeaderText="栈板/箱号" DataField="PALLETCODE" />
                                    </Columns>--%>
                                </asp:GridView>
