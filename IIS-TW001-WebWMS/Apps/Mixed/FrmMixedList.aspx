<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="FrmMixedList.aspx.cs" Inherits="Apps_RD_FrmMixedList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.FrmMixedList_Title01%>-&gt;<%= Resources.Lang.FrmMixedList_Title02%>    <%-- 配料管理-&gt;配料单--%>
</asp:Content>
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
        ...
        <tr valign="top">
            <td valign="top" align="left" class="style1">
                ...
                &nbsp;
                <asp:Button ID="btnComplete" runat="server" CssClass="ButtonDo" Text="<%$ Resources:Lang, FrmMixedList_btnComplete%>" OnClick="btnComplete_Click" OnClientClick="return CheckComplete()" style="display:none;"></asp:Button>  <%--完成--%>
            ...
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdMIXED" runat="server" AllowPaging="True" BorderColor="Teal"
                        DataKeyNames="ID,CSTATUS" BorderStyle="Solid" BorderWidth="1px"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="cstatusname" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmALLOCATEList_Label1%>">  <%--状态--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
