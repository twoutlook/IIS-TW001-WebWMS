<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Apps/DefaultMasterPage.master" CodeFile="FrmMixedStarter.aspx.cs" Inherits="Apps_Mixed_FrmMixedStarter" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetOutBillData(outAsnID) {
            ...
            if (outbillcode != "") {
                $.get(
                "GetOutBillInfoById.aspx?outAsnID=" + outbillcode + "&i=" + i,
                "",
                function (data) {
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtERP_No" runat="server" CssClass="NormalInputText" Width="95%" Enabled="false" ></asp:TextBox>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtPalledCode" runat="server" CssClass="NormalInputText" Width="95%" Enabled="false"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <asp:DropDownList ID="ddlStartSite" runat="server" Width="95%" >
                            </asp:DropDownList>
                            
                            <asp:RequiredFieldValidator ID="rfvddlStartSite" runat="server" ControlToValidate="ddlStartSite"
                                ErrorMessage="<%$ Resources:Lang, FrmMixedStarter_rfvddlStartSite%>" Display="None"> </asp:RequiredFieldValidator> <%--请选择起始站点!--%>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <asp:DropDownList ID="ddlEndSite" runat="server" Width="95%" >
                            </asp:DropDownList>
                            
                            <asp:RequiredFieldValidator ID="rfvddlEndSite" runat="server" ControlToValidate="ddlEndSite"
                                ErrorMessage="<%$ Resources:Lang, FrmMixedStarter_rfvddlEndSite%>" Display="None"> </asp:RequiredFieldValidator> <%--请选择目的站点!--%>
                        </td>
                        <td class="InputLabel" style="width: 13%">
        ...
        <tr valign="top">
            <td valign="top" align="left" class="style1">
                <asp:Button ID="btnSave" runat="server" CssClass="ButtonSave" OnClick="btnSave_Click"
                    Text="<%$ Resources:Lang, FrmMixedStarter_btnSave%>" />  <%--叫车--%>
                &nbsp;&nbsp;
                ...
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdMIXED_D" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="QTY" DataFormatString="" HeaderText="<%$ Resources:Lang, Common_IQUANTITY%>">  <%--数量--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="CREATERTIME" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"
                                HeaderText="<%$ Resources:Lang, FrmMixedList_lblDCREATETIMEFromFrom%>">  <%--配料日期--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
