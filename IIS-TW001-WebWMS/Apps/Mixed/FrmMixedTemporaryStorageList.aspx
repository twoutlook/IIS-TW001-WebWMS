<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmMixedTemporaryStorageList.aspx.cs" MasterPageFile="~/Apps/DefaultMasterPage.master" Inherits="Apps_Mixed_FrmMixedTemporaryStorageList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.FrmMixedList_Title01%>-&gt;<%= Resources.Lang.FrmMixedTemporaryStorageList_Title01%>     <%--配料管理-&gt;配料暂存--%>
</asp:Content>
                    ...
                    <asp:GridView ID="grdMIXED" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CREATERTIME" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"
                             ...
                             <asp:BoundField DataField="ENDSITE" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmMixed_D_Label3%>" >  <%--目的站点--%>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="" DataNavigateUrlFormatString="<%$ Resources:Lang, FrmMixedTemporaryStorageList_Process%>" DataTextField="" 
                                DataTextFormatString="" HeaderText="<%$ Resources:Lang, FrmMixedTemporaryStorageList_ZhanCun%>" Text="<%$ Resources:Lang, FrmMixedTemporaryStorageList_ZhanCun%>">  <%--操作--%>  <%--暂存--%>
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle HorizontalAlign="Center" Wrap="False" />
                            </asp:HyperLinkField>
