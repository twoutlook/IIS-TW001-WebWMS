<%@ Page Title="--出库通知单变更单" Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master"  AutoEventWireup="true" CodeFile="FrmChangeByOutAsn.aspx.cs" Inherits="Apps_OUT_FrmChangeByOutAsn" %>
                ...
                <div style="height: 300px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdOutChange" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="OUTASN_CTICKETCODE" HeaderText="<%$ Resources:Lang, WMS_Common_Element_Outasncode %>"><%--通知单单据--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="CREATE_TIME" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"  HeaderText="<%$ Resources:Lang, WMS_Common_Element_CreateDate %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields=""  DataNavigateUrlFormatString="<%$ Resources:Lang, FrmOUTASNList_ChaKang %>" DataTextField="" DataTextFormatString="" Visible="false" HeaderText="<%$ Resources:Lang, FrmOUTASNList_ChaKang %>" Text="<%$ Resources:Lang, FrmOutChangeAsn_FanAllocateCode %>"><%--查看--%><%--反向调拨单--%>
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle HorizontalAlign="Center" Wrap="False" />
                            </asp:HyperLinkField>
                        </Columns>
