<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowSN_Div.ascx.cs" Inherits="Apps_OUT_ShowSN_Div" %>
...
<script type="text/javascript">
    function SetSNSplit4(ControlName1, Values1, ControlName2, Values2, ControlName3, Values3, ControlName4, Values4) {
                            ...
                            <td colspan="5">
                                <asp:GridView ID="grdSN" runat="server" AllowPaging="false" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, WMS_Common_Element_Quantity %>" DataField="QUANTITY" />
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, ShowSN_Div_InBillCode %>" DataField="CTICKETCODE" />
                                    </Columns>
                                </asp:GridView>
