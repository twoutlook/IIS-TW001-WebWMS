<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowOutASN_Div.ascx.cs" Inherits="Apps_RD_ShowINASN_Div" %>
                    ...
                    <table class="tableFilter" style="width: 95%;">
                        <tr>
                            <td style="width: 15%; white-space: nowrap;">
                                <%= Resources.Lang.WMS_Common_Element_Outasncode %>：
                            </td>
                            <td style="width: 20%;">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="false" BackColor="White" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, WMS_Common_Element_Outasncode %>" DataField="CTICKETCODE" />
                                    </Columns>
                                </asp:GridView>
