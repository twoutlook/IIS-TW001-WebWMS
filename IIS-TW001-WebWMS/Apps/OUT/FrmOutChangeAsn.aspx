<%@ Page Title="--工单变更单" Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="FrmOutChangeAsn.aspx.cs" Inherits="Apps_OUT_FrmOutChangeAsn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.WMS_Common_Menu_ChuKu %>-&gt;<%= Resources.Lang.FrmOutChangeAsn_Menu_PageName %>
</asp:Content>
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 21%">
                            <asp:TextBox ID="txtCOUTASNCode" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Lang, WMS_Common_GridView_Status %>"></asp:Label>：
                        </td>
                        <td style="width: 20%">
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Lang, WMS_Common_Element_CreateOwner %>"></asp:Label>：
                        </td>
                        <td style="width: 20%">
        ...
        <tr>
            <td colspan="6" align="left">
                ...
                &nbsp;&nbsp;<asp:Button ID="btnDelete" OnClick="btnDelete_Click" runat="server" Text="<%$ Resources:Lang,WMS_Common_Button_Delete %>"
        ...
        <tr>
            <td>
                <div style="height: 300px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdOutChange" runat="server" AllowPaging="True" BorderColor="Teal"
                        BorderStyle="Solid" BorderWidth="1px" CellPadding="1" Width="100%" AutoGenerateColumns="False"
                       
                        OnRowDataBound="grdOutChange_RowDataBound" CssClass="Grid" PageSize="15">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ERPCODE" HeaderText="ErpCode">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CREATE_OWNER" DataFormatString="" HeaderText="<%$ Resources:Lang, WMS_Common_Element_CreateOwner %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CREATE_TIME" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}"
                                HeaderText="<%$ Resources:Lang, WMS_Common_Element_CreateDate %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="" DataNavigateUrlFormatString="<%$ Resources:Lang, FrmOUTASNList_ChaKang %>" DataTextField="" DataTextFormatString="" HeaderText="<%$ Resources:Lang, FrmOUTASNList_ChaKang %>" Text="<%$ Resources:Lang, FrmOutChangeAsn_FanAllocateCode %>"><%--查看--%><%--反向调拨单--%>
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle HorizontalAlign="Center" Wrap="False" />
                            </asp:HyperLinkField>
                            <asp:HyperLinkField DataNavigateUrlFields="" DataNavigateUrlFormatString="<%$ Resources:Lang, FrmOUTASNList_ChaKang %>" DataTextField="" DataTextFormatString="" HeaderText="<%$ Resources:Lang, FrmOUTASNList_ChaKang %>" Text="<%$ Resources:Lang, FrmOutChangeAsn_FanAllocateSN %>"><%--查看--%><%--反向调拨单SN--%>
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle HorizontalAlign="Center" Wrap="False" />
                            </asp:HyperLinkField>
                        </Columns>
                    ...
                    <script type="text/javascript" language="javascript">
                        ...
                        //settingPad("<%= grdOutChange.ClientID%>", { "HolderHeight": 170, "HolderWidth": 750, "CtrlWidth": 1000 });
                    </script>
                </div>
            </td>
        </tr>
        <script type="text/javascript">
            ...
            function CheckDel() {
                var number = 0;
                var controls = document.getElementById("<%=grdOutChange.ClientID %>").getElementsByTagName("input");
