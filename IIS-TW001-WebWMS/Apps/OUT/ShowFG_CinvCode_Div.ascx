<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowFG_CinvCode_Div.ascx.cs" Inherits="UserControls_ShowFG_CinvCode_Div" %>
                ...
                <ContentTemplate>
                    <table class="tableFilter" style="width: 95%;">
                        <tr>
                            ...
                            <td style="width: 15%; white-space: nowrap;">
                                <%= Resources.Lang.WMS_Common_Element_Cinvname %>：
                            </td>
                            <td style="width: 20%;">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="false" BackColor="White"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, WMS_Common_Element_Cinvcode %>" DataField="CPARTNUMBER" />
                                        <asp:BoundField HeaderText="<%$ Resources:Lang, WMS_Common_Element_Cinvname %>" DataField="CPARTNAME" />
                                    </Columns>
                                </asp:GridView>
