<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" Title="--盘点单" CodeFile="FrmSTOCK_InventoryPy.aspx.cs" Inherits="FrmSTOCK_InventoryPy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%= Resources.Lang.WMS_Common_Group_StockManage %>-&gt;<%= Resources.Lang.FrmSTOCK_InventoryPy_PageName %><%--物理盘点明细维护--%>
</asp:Content>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblCHECKTYPE" runat="server" Text="<%$ Resources:Lang,WMS_Common_Element_PanDianStatus %>"></asp:Label>：<%--盘点状态--%>
                        </td>
                        <td style="width: 21%; white-space: nowrap;">
                            <asp:DropDownList ID="dplCHECKStatus" runat="server" Width="95%">
                                <%--<asp:ListItem Value="1" Selected="True">全部</asp:ListItem>
                                <asp:ListItem Value="2">初盤</asp:ListItem>
                                <asp:ListItem Value="3">複盤</asp:ListItem>--%>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                ...
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdSTOCK_CHECKBILL" runat="server" AllowPaging="True"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="cstatus" DataFormatString="" HeaderText="<%$ Resources:Lang,WMS_Common_Element_PanDianStatus %>"><%--盘点状态--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
