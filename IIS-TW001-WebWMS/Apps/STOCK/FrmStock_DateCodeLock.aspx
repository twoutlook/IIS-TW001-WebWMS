<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" Title="--DateCode鎖定" CodeFile="FrmStock_DateCodeLock.aspx.cs" Inherits="Stock_FrmStock_DateCodeLock" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function CheckUnLock() {
            var number = 0;
            var controls = document.getElementById("<%=grdDateCodeLock.ClientID %>").getElementsByTagName("input");
        ...
        if (number == 0) {           
            alert("<%= Resources.Lang.FrmStock_DateCodeLock_SelectLocker %>");//请你选择需要解锁的项！
            return false;
        } 
        if (confirm("<%= Resources.Lang.FrmStock_DateCodeLock_JieSuoConfirm %>")) {//你确认解锁吗？
            return true;
        }
        else {
            return false;
        ...
        <tr valign="top">
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    id="tabCondition">
                    <tr>
                        <th align="left" colspan="4">&nbsp;&nbsp;&nbsp;<img src="../../Layout/CSS/LG/Images/Login/icon1.gif" width="5" height="11" alt="" runat="server" id="titleImg" />
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblCCARGOID" runat="server" Text="<%$ Resources:Lang,WMS_Common_Element_LockUser %>"></asp:Label>：<%--锁定人--%>
                        </td>
                        <td style="width: 20%">
                            <asp:TextBox ID="txtLockUser" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="display: none">
                        <td colspan="4">
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            <asp:Button ID="btnDateCodeLock" runat="server" CssClass="ButtonAdd6" Text="<%$ Resources:Lang,FrmStock_DateCodeLock_NewLock %>" Width="84px"></asp:Button><%--新增锁定--%>
                            &nbsp;&nbsp;<asp:Button ID="btnDateCodeUnLock" runat="server" CssClass="ButtonDel" Text="<%$ Resources:Lang,FrmStock_DateCodeLock_UnLock %>" Width="58px" OnClick="btnDateCodeUnLock_Click" OnClientClick="return CheckUnLock()"></asp:Button><%--解锁--%>
        ...
        <tr>
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdDateCodeLock" runat="server" AllowPaging="True" BorderColor="Teal"
                        BorderStyle="Solid" BorderWidth="1px" CellPadding="1" Width="100%" AutoGenerateColumns="False"
                        OnRowDataBound="grdDateCodeLock_RowDataBound" CssClass="Grid" PageSize="15">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="QTY" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmStock_DateCodeLock_LockQty %>"><%--锁定数量--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="LOCKTIME" DataFormatString="{0:yyyy-MM-dd}" HeaderText="<%$ Resources:Lang,WMS_Common_Element_LockTime %>"><%--锁定时间--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                        </Columns>
