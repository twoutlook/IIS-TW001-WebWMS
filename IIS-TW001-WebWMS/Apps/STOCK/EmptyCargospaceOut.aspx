<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmptyCargospaceOut.aspx.cs" Inherits="Apps_STOCK_EmptyCargospaceOut" Title="--空栈板出库" MasterPageFile="~/Apps/DefaultMasterPage.master" %>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblIDS" runat="server" Text="<%$ Resources:Lang,EmptyCargospaceOut_OutCposition %>"></asp:Label>：<%--出库储位--%>
                        </td>
                        <td style="width: 20%">
                        ...
                        <td class="InputLabel" style="width: 20%">
                            <asp:Button runat="server" ID="btnOut" Text="<%$ Resources:Lang,WMS_Common_Button_ASRSOutCposition %>" CssClass="ButtonConfig" OnClick="btnOut_Click" /><%--ASRS出库--%> 
                        </td>
                    </tr>
                </table>
            </td>
