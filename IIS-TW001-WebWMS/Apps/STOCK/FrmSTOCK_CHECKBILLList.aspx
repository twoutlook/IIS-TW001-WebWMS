<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" Title="--盘点单" CodeFile="FrmSTOCK_CHECKBILLList.aspx.cs" Inherits="STOCK_FrmSTOCK_CHECKBILLList" %>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 21%; white-space: nowrap;">
                            <asp:DropDownList ID="dplCHECKTYPE" runat="server" Width="95%" Enabled="false">
                            <%--<asp:ListItem Value="">全部</asp:ListItem>
                                <asp:ListItem Value="0" Selected="True">物理</asp:ListItem>
...
<%--                            <span class="requiredSign" style="left: -50px">*</span>--%>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <asp:TextBox ID="txtPlanName" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" align="center" style="text-align: right;">
                            ...
                            <asp:Button ID="btnSearch_Roblck" runat="server" CssClass="ButtonSearch" OnClick="btnSearch_Roblck_Click" Style="display: none;" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" align="center" class="style1">
                            ...
                            &nbsp;<asp:Button ID="btnNew1" runat="server" CssClass="ButtonDo" Text="<%$ Resources:Lang,FrmSTOCK_CHECKBILLList1_Button_Begin %>" OnClick="btnNew1_Click"></asp:Button><%--开始--%>
                            ...
                            &nbsp;<asp:Button ID="btnImportExcel" runat="server" CssClass="ButtonExcel" Text="<%$ Resources:Lang,FrmOUTASNEdit_Button_DaoRu %>" Enabled="False"></asp:Button><%--导入--%>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <div style="height: 300px; overflow-x: scroll; width: 100%" id="DivScroll">
                        <asp:GridView ID="grdSTOCK_CHECKBILL" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PLANNAME" DataFormatString="" HeaderText="<%$ Resources:Lang,WMS_Common_Element_CheckPlanName %>"><%--盘点计划名称--%>
                                    <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                    <ItemStyle HorizontalAlign="left" Wrap="False" />
                                </asp:BoundField>
