<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowPllentCarton_Div.ascx.cs" Inherits="ShowPllentCarton_Div" %>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="grdCartonSN" runat="server" AllowPaging="True" BackColor="White"
                                    ...
                                    Width="100%" AutoGenerateColumns="False" OnPageIndexChanging="grdCartonSN_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="SN" DataField="SNCODE" />
