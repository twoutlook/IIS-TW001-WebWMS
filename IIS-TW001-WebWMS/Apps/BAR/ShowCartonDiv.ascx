<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShowCartonDiv.ascx.cs" Inherits="ShowCartonDiv" %>
                    ...
                    <table class="tableFilter" style="width: 95%;">
                        <tr>
                            <td style="width: 15%; white-space: nowrap;">
                                <%= Resources.Lang.ShowCartonDiv_BoxSn %>：
                            </td>
                            <td style="width: 20%;">
                                <asp:TextBox ID="txtCode" runat="server" Width="104"></asp:TextBox>
                            </td>
                            <td style="width: 15%; white-space: nowrap;">
                                <%= Resources.Lang.ShowCartonDiv_Name %>：
                            </td>
                            <td style="width: 20%;">
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:GridView ID="gvReport" runat="server" AllowPaging="True" BackColor="White"
                                    ...
                                    DataKeyNames="CARTON_NO" OnSelectedIndexChanging="gvReport_SelectedIndexChanging"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Lang,ShowCartonDiv_BoxSn %>" DataField="CARTON_NO" />
                                        <asp:BoundField HeaderText="<%$ Resources:Lang,ShowCartonDiv_Name %>" DataField="CARTON_NAME" />
                                    </Columns>
                                </asp:GridView>
