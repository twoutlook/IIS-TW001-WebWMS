<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmBAR_PALLET_NewEdit.aspx.cs"
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblCNAME" runat="server" Text="栈板數量："></asp:Label>
                        </td>
                        <td style="width: 20%">
                            ...
                            <asp:RequiredFieldValidator ID="rfvtxtNumber" runat="server" ControlToValidate="txtNumber"
                                ErrorMessage="请填写需要生成的棧板數量!" Display="None"> 
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblICAPACITY" runat="server" Text="栈板类型："></asp:Label>
                        </td>
                        <td style="width: 20%">
