<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true"
    Title="棧板" CodeFile="FrmBAR_PALLET_NList.aspx.cs" Inherits="FrmBAR_PALLET_NList" %>
...
<script type="text/javascript">
    function CheckDel() {
        var number = 0;
        var controls = document.getElementById("<%=grdBAR_PALLET.ClientID %>").getElementsByTagName("input");
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCNAME" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                         <td class="InputLabel" style="width: 13%">
                            <asp:Label ID="lblCCODE" runat="server" Text="编码："></asp:Label>
                        </td>
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCCODE" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                        <tr>
                         <td class="InputLabel" style="width: 13%">
                        ...
                        <td style="width: 35%">
                           <asp:DropDownList runat="server" ID="dplYN" Width="95%">
                        ...
                        <td style="width: 35%">
                           <asp:DropDownList runat="server" ID="dplCode" Width="95%">
                                <asp:ListItem Value="" Selected="True">全部</asp:ListItem>
                        ...
                        <td style="width: 20%">
                            ...
                            <asp:DropDownList ID="drCSTATUS" runat="server" CssClass="NormalInputText" Width="95%">
        ...
        <tr valign="top">
            <td valign="top" align="left">
                ...
                <asp:Button ID="btnNew0" runat="server" CssClass="ButtonAdd" Text="批量" Visible="false">
                </asp:Button>
                &nbsp;
            ...
            &nbsp; <asp:Button ID="btnPrint" runat="server" CssClass="ButtonPrint" Text="打印" 
                ...
                &nbsp; 
                <asp:Button ID="btnBatchPrint" runat="server" CssClass="ButtonPrint" Text="批量" Visible="false"
                    onclick="btnBatchPrint_Click">
                </asp:Button>
            </td>
        </tr>
        <tr valign="top">
            <td valign="top">
              <%--  <cc1:DataGridNavigator3 ID="grdNavigatorBAR_PALLET" runat="server" GridID="grdBAR_PALLET"
                    ShowPageNumber="false" ExcelName="BAR_PALLET" IsDbPager="True" />--%>
            </td>
        </tr>
        <tr>
            <td>
                <div style="height: 300px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdBAR_PALLET"  runat="server"
                        AllowPaging="True" BorderColor="Teal" BorderStyle="Solid" BorderWidth="1px" CellPadding="1"
                        Width="100%" AutoGenerateColumns="False"  OnRowDataBound="grdBAR_PALLET_RowDataBound" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PALLETNO" DataFormatString="" HeaderText="编码">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="PALLETNAME" DataFormatString="" HeaderText="名称">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="TYPENAME" HeaderText="棧板/箱类型">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="" DataNavigateUrlFormatString="库存查询" DataTextField=""
                                DataTextFormatString="" HeaderText="库存查询" Text="库存查询">
                                <HeaderStyle HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle HorizontalAlign="Center" Wrap="False" />
                            </asp:HyperLinkField>
                    ...
                    <script type="text/javascript" language="javascript">
                        ...
                        //settingPad("<%= grdBAR_PALLET.ClientID%>", { "HolderHeight": 170, "HolderWidth": 750, "CtrlWidth": 1000 });
                    </script>
                </div>
            </td>
        </tr>
