<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true"
    Title="BAR_CARTON_M" CodeFile="FrmBAR_CARTON_MList.aspx.cs" Inherits="FrmBAR_PALLET_NList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Head" runat="Server">
    ...
    <script type="text/javascript">
        function CheckDel() {
            var number = 0;
            var controls = document.getElementById("<%=grdBAR_CARTON.ClientID %>").getElementsByTagName("input");
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
                    ...
                    <tr>
                         ...
                         <td style="width: 35%">
                           <asp:DropDownList runat="server" ID="dplCode" Width="95%">
                               ...
                               <asp:ListItem Value="128" Selected="True">Code128</asp:ListItem>
                           </asp:DropDownList>
                        </td>
                    </tr>
                    <tr style="display: none">
        ...
        <tr valign="top">
            <td valign="top" align="left">
                ...
                &nbsp; <asp:Button ID="btnNew0" runat="server" CssClass="ButtonAdd" Text="批量">
                </asp:Button>
                &nbsp;
            ...
            &nbsp;
                <asp:Button ID="btnBatchPrint" runat="server" CssClass="ButtonPrint" Text="批量" 
        ...
        <tr valign="top">
            <td valign="top">
              <%--  <cc1:DataGridNavigator3 ID="grdNavigatorBAR_CARTON" runat="server" GridID="grdBAR_CARTON"
                    ShowPageNumber="false" ExcelName="BAR_CARTON" IsDbPager="True" />--%>
            </td>
        </tr>
        <tr>
            <td>
                <div style="height: 300px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdBAR_CARTON"  runat="server"
                        AllowPaging="True" BorderColor="Teal" BorderStyle="Solid" 
                        BorderWidth="1px" CellPadding="1"
                        Width="100%" AutoGenerateColumns="False"  OnRowDataBound="grdBAR_CARTON_RowDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CARTON_NO" DataFormatString="" HeaderText="编码">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CARTON_NAME" DataFormatString="" HeaderText="名称">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="TYPENAME" HeaderText="箱类型">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                    ...
                    <script type="text/javascript" language="javascript">
                        ...
                        //settingPad("<%= grdBAR_CARTON.ClientID%>", { "HolderHeight": 170, "HolderWidth": 750, "CtrlWidth": 1000 });
                    </script>
                </div>
            </td>
        </tr>
