<%@ Page Language="C#" AutoEventWireup="true" Title="<%$ Resources:Lang, FrmALLOCATE_DEdit_Title%>" MasterPageFile="~/Apps/DefaultMasterPage.master"
    CodeFile="FrmALLOCATEEdit_D.aspx.cs" Inherits="FrmALLOCATEEdit_D" %><%--调拨单详情--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtDINDATE" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                            ...
                            <%-- <asp:RequiredFieldValidator ID="rfvtxtDINDATE" runat="server" ControlToValidate="txtDINDATE"
                                ErrorMessage="请填写调拨日期!" Display="None"> </asp:RequiredFieldValidator>onclick="return showCalendar('ctl00_ContentPlaceHolderMain_txtDINDATE','y-mm-dd',0);"
                    ...
                    <tr style="display: none;">
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtCDEFINE1" runat="server" CssClass="NormalInputText" Width="95%" MaxLength="50"></asp:TextBox>
                        </td>
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtDDEFINE3" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                            <%-- <img border="0" align="absmiddle" alt="" style="cursor: hand; position: relative;
                                left: -30px; top: 0px" src="../../Layout/Calendar/Button.gif" onclick="return showCalendar('ctl00_ContentPlaceHolderMain_txtDDEFINE3','y-mm-dd',0);" />--%>
                            <%--<asp:RegularExpressionValidator ID="revtxtDDEFINE3" runat="server" ValidationExpression="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]"
                                ControlToValidate="txtDDEFINE3" ErrorMessage="请填写有效的自定义3!正确的格式是：yyyy-MM-dd" Display="None"> </asp:RegularExpressionValidator>--%>
                        </td>
                    </tr>
                    <tr style="display: none;">
                        <td class="InputLabel" style="width: 13%">
                        ...
                        <td style="width: 20%">
                            <asp:TextBox ID="txtDDEFINE4" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                            <%-- <img border="0" align="absmiddle" alt="" style="cursor: hand; position: relative;
                            ...
                            <asp:RegularExpressionValidator ID="revtxtDDEFINE4" runat="server" ValidationExpression="[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]"
                                ControlToValidate="txtDDEFINE4" ErrorMessage="请填写有效的自定义4!正确的格式是：yyyy-MM-dd" Display="None"> </asp:RegularExpressionValidator>--%>
                        </td>
                        <td class="InputLabel" style="width: 13%">
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            <td>
                <asp:Button ID="btnCheck" runat="server" CssClass="ButtonYY" Text="<%$ Resources:Lang, FrmALLOCATE_Audit_Mail_btnCheck%>" OnClick="btnCheck_Click"></asp:Button><%--审核--%>
                &nbsp;&nbsp;
            ...
            <td colspan="4">
                <div style="height: 300px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdALLOCATE_D" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        OnRowDataBound="grdALLOCATE_D_RowDataBound" CssClass="Grid" PageSize="15" OnDataBinding="grdALLOCATE_D_DataBinding">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DINDATE" DataFormatString="{0:yyyy-MM-dd}" HeaderText="<%$ Resources:Lang, FrmALLOCATEList_lblDINDATEFromFrom%>"><%--调拨日期--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                    ...
                    <script type="text/javascript" language="javascript">
                        ...
                        //settingPad("<%= grdALLOCATE_D.ClientID%>", { "HolderHeight": 170, "HolderWidth": 750, "CtrlWidth": 1000 });
                    </script>
                </div>
            </td>
        </tr>
