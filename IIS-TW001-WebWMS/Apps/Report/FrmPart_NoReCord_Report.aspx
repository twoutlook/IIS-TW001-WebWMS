<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true"
    Title="--<%$ Resources:Lang, FrmPart_NoReCord_Report_title1 %>" CodeFile="FrmPart_NoReCord_Report.aspx.cs" Inherits="FrmPart_NoReCord_Report" %>
<%--料号未完成单据报表--%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%=Resources.Lang.FrmReport_ReportManagement%>-&gt;<%=Resources.Lang.FrmPart_NoReCord_Report_Content1%><%--料号单据报表 --%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    ...
    <table id="TabMain" style="height: 100%; width: 95%">
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%; white-space: nowrap;">
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:Lang, FrmPart_NoReCord_Report_Label3 %>"></asp:Label>：<%--库存：--%>
                        </td>
                        <td style="width: 20%">
                            <asp:Label ID="labStock" runat="server" ForeColor="#3366FF" Text=""></asp:Label>
                        </td>
                    </tr>
        ...
        <tr valign="top">
            <td valign="top">
             <%--   <cc1:DataGridNavigator3 ID="grdNavigatorStock" runat="server" GridID="grdStock"
                    ShowPageNumber="false" ExcelName="OutBill_SN" IsDbPager="True" OnGetExportToExcelSource="grdNavigatorStock_GetExportToExcelSource" />--%>
            </td>
        </tr>
        <tr>
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdStock" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        OnPageIndexChanged="grdStock_PageIndexChanged" OnPageIndexChanging="grdStock_PageIndexChanging"
                        ...
                        <Columns>
                             <asp:BoundField DataField="TYPE" DataFormatString="" HeaderText="<%$ Resources:Lang, Common_Type %>"> <%--类型--%>
                            ...
                            <asp:BoundField DataField="TYPENAME" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmPart_NoReCord_Report_TYPENAME %>"><%--单据类型--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="QTY" DataFormatString="" HeaderText="<%$ Resources:Lang, Common_NUM %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
