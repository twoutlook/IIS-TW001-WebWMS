<%@ Page Title="" Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="FrmBASE_PART_Report.aspx.cs" Inherits="Apps_Report_FrmBASE_PART_Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%=Resources.Lang.FrmReport_ReportManagement%>-&gt;呆滞料报表
</asp:Content>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1" id="tabCondition">
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 10%">
                            ...
                            <asp:Label ID="Label2" runat="server" Text="呆滞时间："></asp:Label>
                        </td>
                        <td style="width: 15%; white-space: nowrap;">
                            <asp:DropDownList ID="ddlTJ" runat="server" Width="60px">
                                <%--<asp:ListItem Value=">">大于</asp:ListItem>
                                <asp:ListItem Value="=">等于</asp:ListItem>
                                <asp:ListItem Value="<">小于</asp:ListItem>--%>
                            </asp:DropDownList>
                            <asp:TextBox ID="txtTime" runat="server" CssClass="NormalInputText" Width="70" onKeyPress="if (event.keyCode!=46 && event.keyCode!=45 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false"></asp:TextBox>天
                        </td>
                    </tr>
                    <tr>
                ...
                <div style="height: 500px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdINASN" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="cwarehouse" DataFormatString="" HeaderText="<%$ Resources:Lang, Common_WareHouseName %>"></asp:BoundField>
                            <%--仓库名称--%>
                            ...
                            <asp:BoundField DataField="sncode" DataFormatString="" HeaderText="<%$ Resources:Lang, Common_BarCode %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                            ...
                            <asp:BoundField DataField="LastInDate" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" HeaderText="<%$ Resources:Lang, FrmINBILLEdit_MSG29 %>"><%--入库时间--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="LastOutDate" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" HeaderText="出库时间">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="DayDiff" HeaderText="呆滞时间(天)">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
