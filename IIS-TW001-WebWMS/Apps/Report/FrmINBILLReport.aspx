<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true" Title="<%$ Resources:Lang, FrmInbill_InbillCticketCode %>" CodeFile="FrmINBILLReport.aspx.cs" Inherits="FrmINBILLReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%=Resources.Lang.FrmReport_ReportManagement%>-&gt;<%=Resources.Lang.FrmINBILLReport_Content1%><%--入库单报表--%>
</asp:Content>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1" id="tabCondition">
                    ...
                    <tr>
                        <td class="InputLabel" style="width: 13%; white-space: nowrap;">
                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:Lang, WmsDBCommon_ASRS_Msg15 %>"></asp:Label>：
                        </td>
                        <td style="width: 20%">
                        ...
                        <td class="InputLabel" style="width: 13%;">
                            <asp:Label ID="Label6" runat="server" Text="ERP："></asp:Label>
                        </td>
                        <td style="width: 20%">
                    ...
                    <tr>
                        ...
                        <td style="width: 20%; white-space: nowrap;">
                            <asp:TextBox ID="txtDateFrom" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        ...
                        <td style="width: 20%; white-space: nowrap;">
                            <asp:TextBox ID="txtDateTo" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                            <img border="0" align="absmiddle" alt="" style="cursor: pointer; position: relative; left: -30px; top: 0px"
                ...
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdINBILL" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CTICKETCODE" DataFormatString="" HeaderText="<%$ Resources:Lang, WmsDBCommon_ASRS_Msg15 %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TypeCode" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmInbill_InBillTYPE %>">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="center" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <%--<asp:BoundField DataField="cpositioncode" DataFormatString="" HeaderText="区域">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
