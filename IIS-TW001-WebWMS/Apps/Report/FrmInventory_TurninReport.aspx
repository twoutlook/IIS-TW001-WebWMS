<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true"
    Title="--<%$ Resources:Lang, FrmInventory_TurninReport_title1 %>" CodeFile="FrmInventory_TurninReport.aspx.cs" Inherits="FrmInventory_TurninReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%=Resources.Lang.FrmReport_ReportManagement%>-&gt;<%=Resources.Lang.FrmInventory_TurninReport_title1%>
    <%--SN盘入明细报表--%>
</asp:Content>
            ...
            <td valign="top">
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        ...
                        <td class="InputLabel" style="width: 13%; white-space: nowrap;">
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Lang, FrmInventory_TurninReport_MSG1 %>"></asp:Label>：<%--盘点人：--%>
                        </td>
                        <td style="width: 20%">
                            <asp:TextBox ID="txtpanuser" runat="server" CssClass="NormalInputText" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="InputLabel" style="width: 13%; white-space: nowrap;">
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:Lang, FrmInventory_TurninReport_MSG2 %>"></asp:Label>：<%--盘入类型：--%>
                        </td>
                        <td style="width: 20%">
                            <asp:DropDownList ID="ddlsType" runat="server" Width="95%">
                                <%--<asp:ListItem Value="" Selected="True">全部</asp:ListItem>
                                <asp:ListItem Value="0">旧盘</asp:ListItem>
                                <asp:ListItem Value="1">全盘</asp:ListItem>--%>
                            </asp:DropDownList>
                        </td>
                        <td class="InputLabel" style="width: 13%; white-space: nowrap;">
                            <asp:Label ID="lblDINDATEFromFrom" runat="server" Text="<%$ Resources:Lang, FrmInventory_TurninReport_MSG5 %>"></asp:Label>：<%--盘入日期：--%>
                        </td>
            ...
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdINBILL" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        <Columns>
                            <asp:BoundField DataField="stype" DataFormatString="" HeaderText="<%$ Resources:Lang, Common_Type %>"><%--类型--%>
                            ...
                            <asp:BoundField DataField="USERNAME" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmInventory_TurninReport_MSG6 %>"><%--盘入人--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" Width="200px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="DINDATE" DataFormatString="{0:yyyy/MM/dd HH:mm:ss}" HeaderText="<%$ Resources:Lang, FrmInventory_TurninReport_MSG5 %>"><%--盘入日期--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                        </Columns>
