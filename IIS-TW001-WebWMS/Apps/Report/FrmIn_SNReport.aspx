<%@ Page Language="C#" MasterPageFile="~/Apps/DefaultMasterPage.master" AutoEventWireup="true"
     Title="--SN入库明细报表" CodeFile="FrmIn_SNReport.aspx.cs" Inherits="FrmIn_SNReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HolderTitle" runat="Server">
    <%=Resources.Lang.FrmReport_ReportManagement%>-&gt;SN入库明细报表
</asp:Content>
                ...
                <table class="InputTable" cellspacing="0" cellpadding="1" width="100%" border="1"
                    ...
                    <tr>
                        <td class="InputLabel" style="width: 13%;">
                             <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Lang, FrmInbill_WorkType %>"></asp:Label>：
                        </td>
                        <td style="width: 20%;">
                        ...
                        <td colspan="6">
                            <script type="text/javascript" language="javascript">
                                $(document).ready(function () {
                                    FormatSetDate('<%=txtDINDATEFrom.ClientID %>', '<%=txtDINDATETo.ClientID %>');    //第一个参数是开始日期，第二个参数是结束日期
                                              $("#<%=rbtList.ClientID %>").change(function () {
                                                  FormatSetDate('<%=txtDINDATEFrom.ClientID %>', '<%=txtDINDATETo.ClientID %>');
            ...
            <td>
                <div style="height: 450px; overflow-x: scroll; width: 100%" id="DivScroll">
                    <asp:GridView ID="grdINBILL" runat="server" AllowPaging="True" BorderColor="Teal"
                        ...
                        OnPageIndexChanged="grdINBILL_PageIndexChanged" OnPageIndexChanging="grdINBILL_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="cpositioncode" DataFormatString="" HeaderText="<%$ Resources:Lang, FrmInventory_Old_TurninRep_cpositioncode %>"><%--储位--%>
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="DINDATE" DataFormatString="{0:yyyy/MM/dd HH:mm:ss}" HeaderText="上架日期">
                                <HeaderStyle HorizontalAlign="center" Wrap="False" />
                                <ItemStyle HorizontalAlign="left" Wrap="False" />
                            </asp:BoundField>
                        </Columns>
