...
dhtmlXTabBar.prototype = {
    ...
    setOnActiveFunction: function (func) {
        this._onSetActive = func;
    },
    ...
    */
    ...
    _createTab: function (id, text, size) {
        ...
        var thml = "<span style=\"font-size:10pt\">" + text + "</span><div></div><div></div><div></div>";
    ...
    _onClickHandler: function (e) {
        ...
        if (target && !target._disabled) {
            ...
            if (this.tabbar._onSetActive) {
                this.tabbar._onSetActive(target.getAttribute("tab_id"));
            }
        }
        else {
            var tag = null;
